...
class NetworkConstants {
    ...
    static func createUrlString(search: String, location: String, sort: String, limit: Int) -> String {
        ...
        return "https://api.foursquare.com/v3/places/search?query=\(encodedSearch)&categories=13031&fields=fsq_id%2Cname%2Cgeocodes%2Clocation%2Cdistance%2Cdescription%2Ctel%2Cwebsite%2Chours%2Crating%2Cprice%2Cphotos&near=\(encodedLocation)&sort=\(sort)&limit=\(limit)"
    }
}
